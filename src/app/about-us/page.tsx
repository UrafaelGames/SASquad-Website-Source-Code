    ...
    <div className="page-about-us">
      ...
      <div className="mission-vision-section">
        <div className="mission fade-in-up">
          <h2>Our Mission</h2>
          <p>
            Our mission at SASquad Team is to transform the GTA experience
            through innovation and limitless creativity...
          </p>
        </div>
        <div className="vision fade-in-up">
          <h2>Our Vision</h2>
          <p>
            Our vision at SASquad Team is to be recognized as the leading
            innovation group within the GTA modding community...
          </p>
        </div>
      </div>
